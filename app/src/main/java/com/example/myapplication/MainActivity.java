...
public class MainActivity extends AppCompatActivity {
  ...
  /* c) Le premier cas donne les extras de l'intention qui a démarré cette activité, tandis que le second est utilisé lorsque onCreate est invoqué la deuxième fois et plus, par exemple, lors de la rotation de l'appareil. Ce bundle doit être renseigné dans onSaveInstanceState.*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAct.setOnClickListener(btnAct2);

        if (savedInstanceState != null){
            valeur = savedInstanceState.getString("clé");
        }
    }
    ...
    View.OnClickListener btnAct2 = new View.OnClickListener() {
        @Override
